...
<head>
  ...
  <title>SWARAPITA | Upload Data</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?php echo base_url(). 'general/add_excel_relawan'; ?>" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputFile">File input</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" class="form-control" name="fileexcel" id="file" required accept=".xls, .xlsx" />
                        <!-- <input type="file" class="custom-file-input" name="fileexcel" id="file" required accept=".xls, .xlsx" /></p> -->
